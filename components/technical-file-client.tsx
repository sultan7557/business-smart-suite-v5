          ...
          <div className="flex gap-1">
            ...
            {isArchived ? (
              <Button
                ...
                onClick={() => onUnarchive(technicalFile.id)}
                title="Unarchive"
              ...
              <Button
                ...
                size="icon"
                className="h-6 w-6"
                onClick={() => onArchive(technicalFile.id)}
                title="Archive"
            ...
            {canDelete && (
              <Button
                ...
                onClick={() => onDelete(technicalFile.id)}
            ...
            {!isArchived && (
              <>
                <Button
                  ...
                  onClick={() => onHighlight(technicalFile.id)}
                ...
                <Button
                  ...
                  onClick={() => onApprove(technicalFile.id)}
