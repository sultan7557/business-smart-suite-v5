          ...
          <div className="flex gap-1">
            ...
            {isArchived ? (
              <Button
                ...
                onClick={() => onUnarchive(managementReview.id)}
                title="Unarchive"
              ...
              <Button
                ...
                size="icon"
                className="h-6 w-6"
                onClick={() => onArchive(managementReview.id)}
                title="Archive"
            ...
            {canDelete && (
              <Button
                ...
                onClick={() => onDelete(managementReview.id)}
            ...
            {!isArchived && (
              <>
                <Button
                  ...
                  onClick={() => onHighlight(managementReview.id)}
                ...
                <Button
                  ...
                  onClick={() => onApprove(managementReview.id)}
