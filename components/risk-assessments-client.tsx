          ...
          <div className="flex gap-1">
            ...
            {isArchived ? (
              <Button
                ...
                onClick={() => onUnarchive(riskAssessment.id)}
                title="Unarchive"
              ...
              <Button
                ...
                size="icon"
                className="h-6 w-6"
                onClick={() => onArchive(riskAssessment.id)}
                title="Archive"
            ...
            {canDelete && (
              <Button
                ...
                onClick={() => onDelete(riskAssessment.id)}
            ...
            {!isArchived && (
              <>
                <Button
                  ...
                  onClick={() => onHighlight(riskAssessment.id)}
                ...
                <Button
                  ...
                  onClick={() => onApprove(riskAssessment.id)}
