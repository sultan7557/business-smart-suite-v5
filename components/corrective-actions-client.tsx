          ...
          <div className="flex gap-1">
            ...
            {isArchived ? (
              <Button
                ...
                onClick={() => onUnarchive(correctiveAction.id)}
                title="Unarchive"
              ...
              <Button
                ...
                size="icon"
                className="h-6 w-6"
                onClick={() => onArchive(correctiveAction.id)}
                title="Archive"
            ...
            {canDelete && (
              <Button
                ...
                onClick={() => onDelete(correctiveAction.id)}
            ...
            {!isArchived && (
              <>
                <Button
                  ...
                  onClick={() => onHighlight(correctiveAction.id)}
                ...
                <Button
                  ...
                  onClick={() => onApprove(correctiveAction.id)}
