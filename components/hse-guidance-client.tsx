          ...
          <div className="flex gap-1">
            ...
            {isArchived ? (
              <Button
                ...
                onClick={() => onUnarchive(hseGuidance.id)}
                title="Unarchive"
              ...
              <Button
                ...
                size="icon"
                className="h-6 w-6"
                onClick={() => onArchive(hseGuidance.id)}
                title="Archive"
            ...
            {canDelete && (
              <Button
                ...
                onClick={() => onDelete(hseGuidance.id)}
            ...
            {!isArchived && (
              <>
                <Button
                  ...
                  onClick={() => onHighlight(hseGuidance.id)}
                ...
                <Button
                  ...
                  onClick={() => onApprove(hseGuidance.id)}
