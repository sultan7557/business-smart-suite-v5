...
import { Plus, Archive, Edit, Trash2, Eye, Check, X, Home} from 'lucide-react'
...
export default function ObjectivesClient({
  ...
  const renderObjectivesTable = (objectives: any[], title: string) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {renderObjectivesTable(openObjectives, "Open objectives")}
      {renderObjectivesTable(completedObjectives, "Completed objectives")}
    </div>
  );
}